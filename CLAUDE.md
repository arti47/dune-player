...
- [x] **Phase 4 — In-Play Systems** *(lifecycle, advancement, extended-task tracker, guided defeat/recovery, and the local conflict helper all in; §3.8 statement-recovery flow folds into End adventure)*
