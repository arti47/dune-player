...
| `gm.js` | GM dashboard (gated by `Settings.gmScreen`): Threat/Momentum pools, party peek sheets, searchable NPC compendium, §3.16 rollable tables (`storyHookIndex`/`rowForRoll` + Story Hook & enemy generators). |
