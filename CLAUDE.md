...
1. **House type** (narrative core: Nascent · Minor · Major · Great). *Great Game adds* the
   skill array (Nascent 6/5/5/4/4 · Minor 7/6/6/5/4 · Major 8/7/6/5/4 · Great 9/8/7/6/5),
   the primary/secondary domain counts (0/1 · 1/1 · 1/2 · 2/3), and the GM's **starting Threat
   per player** by type (Nascent 0 · Minor 1 · Major 2 · Great 3 — `startingThreatPerPlayer`).
2. **Domains** (Artistic, Espionage, Farming, Industrial, Kanly, Military, Political,
   ...
   2 R / 10 W. E.g. primary Machinery 12 R / 32 W, primary Expertise 6 R / 44 W — plus the
   **areas-of-expertise detail** (`domainDetails`: a description + Machinery/Produce/Expertise/
   Workers/Understanding example lists for all 9 domains) and the primary-vs-secondary meaning
   (`domainGuidance`). Full tables in `data-great-game.js`.
