...
- [~] **Phase 3 — Dice Engine** *(core skill-test roller in; opposed/assist/talent-automation/Architect/citations deferred to later Phase-3 passes)*
  ...
  - [~] Trait auto-application — the roll dialog lists the character's traits; applying one shifts **Difficulty** (§3.6 modifier model: negative +1, positive −1, clamped 0–5), with a live "Effective Difficulty" pill. *(assists still pending)*
  - [ ] Assists (1d20, leader-success gate) — needs multiple characters (Phase 4/5)
